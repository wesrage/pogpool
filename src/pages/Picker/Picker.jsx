...
export default class Picker extends React.Component {
  state = {
    picks: loadFromStorage('2021-picks', {}),
    user: loadFromStorage('2021-user', {
      firstName: '',
      lastName: '',
    }),
    photosVisible: true,
  ...
  persist = () => {
    localStorage.setItem('2021-picks', JSON.stringify(this.state.picks))
    localStorage.setItem('2021-user', JSON.stringify(this.state.user))
  }
  ...
  render() {
    ...
    return (
      <PickerRoot>
        <Helmet>
          <title>PuckOverGlass 2021 Stanley Cup Playoff Pool</title>
        </Helmet>
        <NotificationSystem
          ref={e => {
        ...
        <Annotation>
          ...
          <p>Submission Deadline: Saturday, May 15, 2021 @ 7:00 PM EDT</p>
        </Annotation>
